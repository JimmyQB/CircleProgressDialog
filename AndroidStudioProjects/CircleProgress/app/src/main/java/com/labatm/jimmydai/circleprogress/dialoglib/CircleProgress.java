...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircleProgress_borderWidth,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.cp_red);
        mColors[1] = context.getResources().getColor(R.color.cp_yellow);
        mColors[2] = context.getResources().getColor(R.color.cp_green);
        mColors[3] = context.getResources().getColor(R.color.cp_blue);
